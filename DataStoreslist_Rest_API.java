package com.pfadmin.dsl; // Package declaration
...
public class DataStoreslist { // Define the public class

    private static final String API_URL = "https://localhost:9999/pf-admin-api/v1/dataStores"; // API endpoint URL
