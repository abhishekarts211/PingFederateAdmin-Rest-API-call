package com.pfadmin.apclist; // Package declaration
...
public class PingFederateApiAuthenticationpolicycontractlist { // Define the public class

    private static final String API_URL = "https://localhost:9999/pf-admin-api/v1/authenticationPolicyContracts"; // API endpoint URL
