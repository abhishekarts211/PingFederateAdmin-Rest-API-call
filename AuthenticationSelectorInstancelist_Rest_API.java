...
public class AuthenticationSelectorInstancelist { // Define the public class

    private static final String API_URL = "https://localhost:9999/pf-admin-api/v1/authenticationSelectors"; // API endpoint URL
