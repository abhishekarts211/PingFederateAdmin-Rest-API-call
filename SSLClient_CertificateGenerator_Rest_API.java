package com.pfadmin.clientcertgen; // Define the package name
...
public class PingFederateApiSSLClientcertificategenerator { // Define the public class

    // API endpoint URL for generating SSL certificates
    private static final String API_URL = "https://localhost:9999/pf-admin-api/v1/keyPairs/sslClient/generate";
    ...
    public static void main(String[] args) { // Main method to execute the program
        try {
            ...
            String jsonPayload = "{\n" +
                    "  \"id\": \"sslclient2\",\n" + // JSON field for ID (ensure lowercase as per validation)
                    "  \"commonName\": \"sslclient2\",\n" + // JSON field for common name
                    "  \"subjectAlternativeNames\": [\n" + // JSON field for subject alternative names
                    "    \"sslclient2\"\n" + // JSON value for subject alternative names
                    "  ],\n" +
                    "  \"organization\": \"pflearning\",\n" + // JSON field for organization
                    "  \"organizationUnit\": \"Training\",\n" + // JSON field for organization unit
                    "  \"city\": \"Bengaluru\",\n" + // JSON field for city
                    "  \"state\": \"Karnataka\",\n" + // JSON field for state
                    "  \"country\": \"IN\",\n" + // JSON field for country
                    "  \"validDays\": 365,\n" + // JSON field for the number of valid days
                    "  \"keyAlgorithm\": \"RSA\",\n" + // JSON field for key algorithm
                    "  \"keySize\": 2048,\n" + // JSON field for key size
                    "  \"signatureAlgorithm\": \"SHA256withRSA\"\n" + // JSON field for signature algorithm
                    "}";
