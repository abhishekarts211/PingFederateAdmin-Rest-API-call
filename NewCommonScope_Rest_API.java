...
package com.pfadmin.scope; // Define the package name
...
public class NewCommonScope { // Define the public class

    // API endpoint URL for generating SSL certificates
    private static final String API_URL = "https://localhost:9999/pf-admin-api/v1/oauth/authServerSettings/scopes/commonScopes";
    ...
    public static void main(String[] args) { // Main method to execute the program
        try {
            ...
            String jsonPayload = "{\n" +
            "  \"name\": \"restapitest\",\n" + // JSON field for name
            "  \"description\": \"Testing\",\n" + // JSON field for description
            "  \"dynamic\": false\n" + // JSON field for dynamic
            "}";
